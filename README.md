...
| Storey containment | each element in the storey of the Level its record names, or of its base constraint where it names two | Core Interior all 854 in Revit's storey; Snowdon Towers 5,612 in Revit's storey, 45 in another and 294 whose record names no Level (RE-27, RE-59) |
