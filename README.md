...
| Names | `Family:Type:ElementId`, `ObjectType` `Family:Type`, for family instances and, since RE-63, walls, curtain walls, floors, ceilings, roofs and railings | 4,397 family instances named exactly as Revit names them; Snowdon's 1,077 walls, 20 roofs and 68 ceilings and Core Interior's 460 system-family elements all named as Revit names them (RE-63) |
