...
| Curtain walls | `IfcCurtainWall` aggregating its panels and mullions, with no body of its own; a panel that holds a basic wall is an `IfcCurtainWall` with its body | Snowdon Towers 60 of 60 and RE1 1 of 1; all 2,075 of Snowdon's panel and mullion relations are Revit's own (RE-46, RE-62, RE-72) |
