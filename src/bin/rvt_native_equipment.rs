...
#[command(
    ...
    after_help = "Output must not exist. Exit 0 means bounded extraction completed; 2 means incomplete document graph coverage; 1 means extraction failed. Neither 0 nor 2 establishes full equipment attribute parity."
)]
struct Args {
    file: PathBuf,
    #[arg(long)]
