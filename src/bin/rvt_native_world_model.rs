...
#[command(
    ...
    after_help = "No external parser or API witness input. Output must not exist. Exit 0 means bounded extraction completed; 2 means incomplete graph coverage or unsupported projections; 1 means extraction failed. Neither 0 nor 2 establishes full equipment attribute parity."
)]
struct Args {
    file: PathBuf,
    #[arg(long)]
