//! Explicit OGS advanced-material kernel reproduction.
//!
//! Implementation-derived equations, independently validated against executable
//! GLSL extracted from the installed Revit 2027 OGSDevices implementation.
//! This API consumes evaluated, linear shader inputs. It does not select Revit's
//! backend, resolve textures, interpret color spaces, or reproduce a whole image.
...
pub fn bind_generic(root: &crate::native_appearance::Node) -> Option<GenericBinding> {
    ...
    Some(GenericBinding {
        ...
        kernel_profile: "ogs_advanced_material_explicit_inputs_v1",
...
/// OGS Blinn-Phong alternative to the Ward distribution.
...
/// Isotropic OGS Ward lobe. Inputs are unit normal, unit half-vector and
