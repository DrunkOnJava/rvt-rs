//! Explicit texture resources and texture-stage evaluation.
...
/// Programmable-linearization branch: filter first, then linearize RGB,
...
/// Planar transform constructor: S * Rz * T, for column-vector inputs.
...
mod tests {
    ...
    fn filtered_normal_near_midgray_retains_gpu_precision() {
        ...
        .unwrap();
        // Synthetic weighted-sum normal. The interpolation
