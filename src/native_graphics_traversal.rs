//! Bounded traversal of saved graphics, under the witnessed DDC 18.4.3 default
...
impl Walker<'_, '_> {
    ...
    fn visit_inner(
        ...
        // outside special draw mode7. DDC default export witnesses normal mode.
        ...
        match obj.class_name.as_str() {
            ...
            "GElement" | "GGroup" | "GFilter" => {
                ...
                if obj.class_name == "GFilter" {
                    ...
                    for p in conditions {
                        ...
                        {
                            let witness="DDC18.4.3 default: integer parameter7/value2/comparison0 accepted in native runtime; Revit semantic meaning unqualified".to_string();
                            if !self.result.default_profile_witnesses.contains(&witness) {
                                self.result.default_profile_witnesses.push(witness);
                            }
                        }
            ...
            "GComponentRef" => {
                // Native component drawing first calls shouldBeDrawn(symbol,viewport).
...
// Native DDC default context is view type4. Direction predicates6/7/8 are
...
fn condition_at_detail(class: &str, v: &Value, detail_level: i64) -> Result<bool, String> {
    ...
    // TB_Geometry 18.4.3 jump-table entry4 targets the comparison directly,
    // preserving actual=4. Runtime witnesses independently record this context.
...
mod tests {
    ...
    #[test]
    fn captured_conditions_and_unknown_type() {
        assert_eq!(
            condition(
                "GConditionInt",
    ...
    #[test]
    fn only_witnessed_unknown_integer_case_is_profile_accepted() {
        assert_eq!(
            condition(
                "GConditionInt",
